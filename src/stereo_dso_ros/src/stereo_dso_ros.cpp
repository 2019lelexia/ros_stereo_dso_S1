...
void settingsDefault(int preset)
{
    ...
    if(preset == 0 || preset == 1)
    {
        ...
        setting_desiredImmatureDensity = 2000;    //original 1500. set higher
        setting_desiredPointDensity = 2500;       //original 2000
        setting_minFrames = 9;
        setting_maxFrames = 13;
...
int main( int argc, char** argv )
{
    ...
    */
    ...
    fullSystem->printResult("/home/zml/桌面/code/catkin_ws/result.txt");
